...
//        List<Integer> list = sentimentService.analyzeDatabaseByTypeAndClassification("Sentimental", "Greenpeace", "Tweet");
...
//        if(!type.equals("Grey")) {
//            List<Integer> list = sentimentService.analyzeDatabaseByTypeAndClassification(classification,"Greenpeace","Tweet");
//            model.addAttribute("sentimentAndImages", list.get(0));
//            model.addAttribute("sentimentAndEmojis", list.get(1));
//            model.addAttribute("fullSearch", list.get(2));
//        }else{
//            model.addAttribute("listOfTweets",getPagination(sentimentService.findAllOtherTweets("Greenpeace"),1, model));
